...
module.exports = function() {
    ...
    app.use('/download',
        function(req, res, next) {
            if (!req.headers.authorization && req.query.auth_token) {
                //this should not be necessary!
                req.headers.authorization = req.query.auth_token;
                req.feathers.headers.authorization = req.query.auth_token;
                console.log("attached token ", req.query.auth_token);
            }
            next();
        },
